...
public class ItemDAO {
    ...
    public static void add(Models.Item i) throws SQLException {
    ...
    public static List<Models.Item> getAll() throws SQLException {
        String sql = "SELECT ID, UnitPrice, Name, Stock FROM ITEMS ORDER BY ID";
        List<Models.Item> list = new ArrayList<>();
    ...
    public static Models.Item getById(int id) throws SQLException {
    ...
    public static void update(Models.Item i) throws SQLException {
